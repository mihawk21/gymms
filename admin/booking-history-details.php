...
$sql="INSERT INTO tblpayment(bookingID,paymentType,payment) Values(:bookingid,:Paymenttype,:ParcialPayment);
update tblbooking set paymentType=:Paymenttype where id=:bookingid";
$query = $dbh -> prepare($sql);
$query->bindParam(':bookingid',$bookingiid,PDO::PARAM_STR);
          ...
          <div class="col-md-12">
            ...
            <select name="Paymenttype" id="Payment" class="form-control">
              ...
              <option value="Full Payment">Full Payment</option>
                ...
                <input type="hidden" name="bookingiid" id="bookingiid" value="<?php echo $bookingid; ?>">
            <br>
          </div>
